  ...
  "playersPanel": {
    ...
    "enemySpottedMarker": {
      ...
      "format": {
        ...
        "lost": "<img src='xvmres://icons/keho/Rama/1.png' width='20' height='20'>",
        // Enemy currently revealed at minimap.
        // Виден на миникарте прямо сейчас.
        "revealed": "<img src='xvmres://icons/keho/Rama/2.png' width='20' height='20'>",
        // Dead enemy.
        // Уничтоженный враг.
        "dead": "<img src='xvmres://icons/keho/a/frag.png' width='14' height='14'>",
    ...
    "medium": {
      ...
      "formatLeft": "<font face='Consolas' size='12'><font color='{{c:eff}}'>{{eff:4}}</font></font> {{name}} <font color='#FF99FF'>{{clan}}</font>",
      // Display format for the right panel (macros allowed, see readme-en.txt).
      // Формат отображения для правой панели (допускаются макроподстановки, см. readme-ru.txt).
      "formatRight": "<font color='#FF99FF'>{{clan}}</font> {{name}} <font face='Consolas' size='12'><font color='{{c:eff}}'>{{eff:4}}</font></font>"
    },
    ...
    "large": {
      ...
      "nickFormatLeft": "<font face='Consolas' size='12'> <font color='{{c:kb}}'>{{kb:3}}</font> <font color='{{c:rating}}'>{{rating:3}}</font> </font> {{name}} <font color='#FF99FF'>{{clan}}</font>",
      "nickFormatRight": "<font color='#FF99FF'>{{clan}}</font> {{name}} <font face='Consolas' size='12'><font color='{{c:rating}}'>{{rating:3}}</font> <font color='{{c:kb}}'>{{kb:3}}</font> </font>",
      ...
      "vehicleFormatLeft": "<font face='Consolas' size='12'><font color='{{c:eff}}'>{{eff:4}}</font></font>",
      "vehicleFormatRight": "<font face='Consolas' size='12'><font color='{{c:eff}}'>{{eff:4}}</font></font>"
    }
  }
}
