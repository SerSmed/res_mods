 ...
 */
{
  ...
  "definition": {
    ...
    // Config description.
    // Описание конфига.
    "description": "Mods XVM Black & White v1.0",

    // Address to config updates.
    // Адрес, где выкладываются обновления конфига.
    "url": "http://www.koreanrandom.com/forum/topic/5615-500-140913-keho-super-%D0%BC%D0%BE%D0%B4-png-xvm-black-white-%D0%B4%D0%BB%D1%8F-088/",
