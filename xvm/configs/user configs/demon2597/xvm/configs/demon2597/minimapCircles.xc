 ...
 */
{
  ...
  "circles": {
        ...
        "major": [
            ...
            { "enabled": false, "distance": 50, "thickness": 1, "alpha": 30, "color": "0xFFCC66" }
        ],
   ...
   // Дальнобойность САУ
          // level 2
            ...
            { "gb25_loyd_carrier":		{"$ref": { "path": "def.range" }, "distance": 509 } },
          // level 3
            ...
            { "gb27_sexton":			{"$ref": { "path": "def.range" }, "distance": 1051} },
            { "gb78_sexton_i":		{"$ref": { "path": "def.range" }, "distance": 1051} },  
          // level 4
            ...
            { "gb26_birch_gun":		{"$ref": { "path": "def.range" }, "distance": 1051} },
          // level 5
            ...
            { "gb28_bishop":			{"$ref": { "path": "def.range" }, "distance": 500 } },
          // level 6
            ...
            { "gb77_fv304":			{"$ref": { "path": "def.range" }, "distance": 500 } },
          // level 7
            ...
            { "gb29_crusader_5inch":	{"$ref": { "path": "def.range" }, "distance": 1327} },
          // level 8
            ...
            { "gb79_fv206":			{"$ref": { "path": "def.range" }, "distance": 1405} },
          // level 9
            ...
            { "gb30_fv3805":			{"$ref": { "path": "def.range" }, "distance": 1354} },
          // level 10
            ...
            { "gb31_conqueror_gun":	{"$ref": { "path": "def.range" }, "distance": 1007} }
        ]
    }
}