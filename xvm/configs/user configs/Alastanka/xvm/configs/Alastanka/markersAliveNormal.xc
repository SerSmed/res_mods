 ...
 */
{
  ...
  "damageText": {
    ...
    "damageMessage": "<img src='xvmres://icons/{{c:dmg-kind}}.png' width='52' height='45'><img src='xvmres://icons/dmg/{{c:dmg}}.png' width='30' height='30'> <font color='{{c:dmg-kind}}'>-{{dmg}} ({{hp-ratio}}\u0025)</font>",
